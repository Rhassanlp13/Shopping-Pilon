const CACHE_NAME = 'shopping-pilon-v5';
const urlsToCache = [
  '/', '/index.html', '/admin.html', '/confirmar.html', '/style.css',
  '/js/app.js', '/js/auth.js', '/js/ui.js', '/js/carrito.js', '/js/productos.js',
  '/js/supabase.js', '/js/config.js', '/js/admin.js', '/js/confirmar.js',
  '/js/modules/toast.js', '/js/utils/escape.js',

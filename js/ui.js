...
export const UI = {
    ...
    // Nueva función simplificada: no guarda pedido, solo envía WhatsApp
    async enviarWhatsApp() {
        ...
        // Abrir WhatsApp para cada grupo de vendedor
        ...
        // Vaciar carrito y cerrar modal después de enviar
        setTimeout(() => {
            carrito.vaciar();
            this.actualizarContador();
            this.renderProductos();
